		...
		return (
			<div className="rde-main">
				<Helmet>
					...
					<meta
						name="description"
						content="Studio Version 2 has started to developed direct manipulation of editable design tools like Powerpoint, We've developed it with react.js, ant.design, fabric.js "
					/>
