...
const plugins = [
	...
	new HtmlWebpackPlugin({
		filename: 'index.html',
		title: 'Studio Version 2',
		meta: {
			description: `Studio Version 2 has started to developed direct manipulation of editable design tools like Powerpoint, We've developed it with react.js, ant.design, fabric.js`
		}
	}),
